...
bool connectDB() {
    ...
    wstring connStr = L"DRIVER={ODBC Driver 17 for SQL Server};SERVER=PSILENL084;DATABASE=librarydatabase;Trusted_Connection=Yes;Integrated Security=SSPI;";
...
query += "', '";query += isbn;
query += "', '";query += edition;
query += "', ";query += to_string(year);
query += ", ";query += to_string(price);
query += ", '";query += shelf;
